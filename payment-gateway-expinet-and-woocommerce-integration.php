<?php
/*
 * Plugin Name: Payment Gateway for Expinet and for WooCommerce
 ...
 * Requires PHP: 7.4
 * Text Domain: payment-gateway-expinet-and-woocommerce-integration
...
function expipaga_activate_plugin() {
    ExpinetGatewayforWoocommerce\Activator::activate();
}

// Deactivation hook
register_deactivation_hook( __FILE__, 'expipaga_deactivate_plugin' );
function expipaga_deactivate_plugin() {
    ExpinetGatewayforWoocommerce\Deactivator::deactivate();
}
